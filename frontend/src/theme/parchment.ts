...
export const parchmentOverrides: GlobalThemeOverrides = {
  ...
  Button: {
    ...
    textColorDisabled: 'rgba(61, 43, 31, 0.35)',
    colorOpacitySecondary: '0.20',
    colorOpacitySecondaryHover: '0.26',
    colorOpacitySecondaryPressed: '0.32',
    // Primary
    colorPrimary: 'rgba(237, 224, 204, 0.92)',
    colorHoverPrimary: '#e0cbab',
    colorPressedPrimary: '#B5976E',
    colorFocusPrimary: '#C9AE8A',
    colorDisabledPrimary: 'rgba(201, 174, 138, 0.35)',
    borderPrimary: '1px solid #C9AE8A',
    borderHoverPrimary: '1px solid #D8C1A3',
    borderPressedPrimary: '1px solid #B5976E',
    borderFocusPrimary: '1px solid #C9AE8A',
    borderDisabledPrimary: '1px solid rgba(201, 174, 138, 0.2)',
    textColorPrimary: '#3D2B1F',
    textColorHoverPrimary: '#3D2B1F',
    textColorPressedPrimary: '#3D2B1F',
    textColorFocusPrimary: '#3D2B1F',
    textColorDisabledPrimary: 'rgba(61, 43, 31, 0.4)',
    // Info
    colorInfo: '#5F726C',
