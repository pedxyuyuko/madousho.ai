...
export const starryNightOverrides: GlobalThemeOverrides = {
  ...
  Button: {
    ...
    // Primary
    colorPrimary: 'rgba(36, 27, 93, 0.85)',
    colorHoverPrimary: 'rgba(41, 26, 142, 0.85)',
    colorPressedPrimary: '#5f2fbe',
    colorFocusPrimary: '#6d3bcf',
    colorDisabledPrimary: 'rgba(109, 59, 207, 0.35)',
    ...
    borderPrimary: '1px solid rgba(109, 59, 207, 0.5)',
    borderHoverPrimary: '1px solid #7b4add',
    borderPressedPrimary: '1px solid #5f2fbe',
    borderDisabledPrimary: '1px solid rgba(109, 59, 207, 0.2)',
    rippleColorPrimary: '#7b4add',
    // Info
    colorInfo: '#6366f1',
